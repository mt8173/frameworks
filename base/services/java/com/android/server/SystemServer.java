...
public final class SystemServer {
    ...
    private static final String HDMI_SERVICE_CLASS =
            "com.mediatek.hdmi.MtkHdmiManagerService$Lifecycle";
    /// @}
    ...
    private void startOtherServices() {
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!disableNonCoreServices
                ...
                traceBeginAndSlog("StartHdmiService");
                try {
                    mSystemServiceManager.startService(HDMI_SERVICE_CLASS);
                } catch (Throwable e) {
                    reportWtf("starting hdmi service", e);
                }
                Trace.traceEnd(Trace.TRACE_TAG_SYSTEM_SERVER);
            }
            /// @}
