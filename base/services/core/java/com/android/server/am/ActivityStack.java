...
final class ActivityStack {
    ...
    private boolean resumeTopActivityInnerLocked(ActivityRecord prev, ActivityOptions options) {
        ...
        //-------------------------------by xin
        Slog.i("xin_log", "+++++++++++resumeTopActivityLocked(i,j),i="+prev+"ops="+options);
        String pkgName=next!=null?next.packageName:null;
        Slog.i("xin_log","moveTaskToFront:resuming activity,package="+pkgName);
        Intent keymappingIntent = new Intent("softwin.intent.action.keymapping");
        keymappingIntent.putExtra("packageName", pkgName);
        keymappingIntent.setPackage("android");
        mService.mContext.sendBroadcast(keymappingIntent);
        //-------------------------------by xin
