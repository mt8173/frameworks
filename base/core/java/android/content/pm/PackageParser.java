...
public class PackageParser {
    ...
    private Activity parseActivity(Package owner, Resources res,
        ...
        if (!receiver) {
			...
			if(a.info.screenOrientation == SCREEN_ORIENTATION_LANDSCAPE && (SystemProperties.getInt("ro.sf.hwrotation",0) == 90)){
				a.info.screenOrientation = SCREEN_ORIENTATION_REVERSE_LANDSCAPE;
			}
