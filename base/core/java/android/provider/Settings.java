...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            //MOVED_TO_GLOBAL.add(Settings.Global.SHOW_PERCENTAGE);
    ...
    public static final class Global extends NameValueTable {
		...
		/**
		 * Whether show percentage
		 */
		public static final String SHOW_PERCENTAGE = "show_percentage";
		
		
		/**
		 * Whether show net speed
		 */
		public static final String SHOW_NETSPEED = "show_netspeed";
