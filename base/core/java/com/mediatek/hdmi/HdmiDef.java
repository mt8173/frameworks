...
public class HdmiDef {
    ...
    public static final int RESOLUTION_3840X2160P23_976HZ = 19;
    public static final int RESOLUTION_3840X2160P_24HZ = 20;
    public static final int RESOLUTION_3840X2160P_25HZ = 21;
    public static final int RESOLUTION_3840X2160P29_97HZ = 22;
    public static final int RESOLUTION_3840X2160P_30HZ = 23;
    public static final int RESOLUTION_4096X2161P_24HZ = 24;
...
/*the 2160 mean 3840x2160 */
    public static final int SINK_2160P23976 = (1 << 0);
    public static final int SINK_2160P24 = (1 << 1);
    public static final int SINK_2160P25 = (1 << 2);
    public static final int SINK_2160P2997 = (1 << 3);
    public static final int SINK_2160P30 = (1 << 4);
/*the 2161 mean 4096x2160 */
    public static final int SINK_2161P24 = (1 << 5);
    ...
    public static int[] sResolutionMask = new int[] { SINK_480P, SINK_576P,
            ...
            SINK_1080P60, SINK_1080P50, 0, 0, 0, 0, 0, 0};

    public static int[] sResolutionMask4k2k = new int[] { SINK_2160P23976, SINK_2160P24,
            SINK_2160P25, SINK_2160P2997, SINK_2160P30, SINK_2161P24};

    public static int[] getAllResolutions() {
        int[] resolutions = new int[] { RESOLUTION_4096X2161P_24HZ,
    ...
    public static int[] getPreferedResolutions(int index) {
        ...
        if (0 == index) {
            ...
            prefered = new int[] { AUTO + RESOLUTION_4096X2161P_24HZ,
                    ...
                    AUTO + RESOLUTION_3840X2160P29_97HZ,
