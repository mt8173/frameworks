...
public class NavigationBarInflaterView extends FrameLayout implements TunerService.Tunable {
    ...
    public static final String SUB_VOLUME = "sub_volume";
    public static final String CAPTURE_PIC = "capture_pic";
    ...
    protected void inflateLayout(String newLayout) {
        ...
        inflateButtons(start, (ViewGroup) mRot0.findViewById(R.id.ends_group), rot0);
        inflateButtons(start, (ViewGroup) mRot90.findViewById(R.id.ends_group), rot90);

        inflateButtons(center, (ViewGroup) mRot0.findViewById(R.id.center_group), rot0);
        inflateButtons(center, (ViewGroup) mRot90.findViewById(R.id.center_group), rot90);

        addGravitySpacer((LinearLayout) mRot0.findViewById(R.id.ends_group));
        addGravitySpacer((LinearLayout) mRot90.findViewById(R.id.ends_group));

        inflateButtons(end, (ViewGroup) mRot0.findViewById(R.id.ends_group), rot0);
        inflateButtons(end, (ViewGroup) mRot90.findViewById(R.id.ends_group), rot90);
    }
    ...
    protected View inflateButton(String buttonSpec, ViewGroup parent, boolean landscape,
		...
		else if (ADD_VOLUME.equals(button)) {
           v = inflater.inflate(R.layout.add_volume, parent, false);
			if (landscape) {
				v.setVisibility(View.GONE);
			}
			setupLandButton(v);
        } else if (SUB_VOLUME.equals(button)) {
            v = inflater.inflate(R.layout.sub_volume, parent, false);
			if (landscape) {
				v.setVisibility(View.GONE);
			}
			setupLandButton(v);
        } 
		else if (CAPTURE_PIC.equals(button)) {
            v = inflater.inflate(R.layout.capture_pic, parent, false);
			// if (!landscape) {
