...
public class NavigationBarView extends LinearLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
		...
		mButtonDisatchers.put(R.id.capture_pic, new ButtonDispatcher(R.id.capture_pic)); 
    ...
    public ButtonDispatcher getCapturePicButton() {
       return mButtonDisatchers.get(R.id.capture_pic);
    }
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
		...
		getCapturePicButton().setVisibility(View.VISIBLE);
    ...
    public void onFinishInflate() {
		...
		getCapturePicButton().setOnClickListener(mScreenshotClickListener);
            ...
            ServiceConnection conn = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    synchronized (mScreenshotLock) {
                        ...
                        try {
                            messenger.send(msg);
                            //Slog.d(TAG,"bbai take screenshot");
                        } catch (RemoteException e) {
                        }
                    }
                }
