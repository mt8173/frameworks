...
public class BrightnessTile extends QSTile<QSTile.BooleanState> {
    ...
    private final AnimationIcon mEnable =
            new AnimationIcon(R.drawable.ic_signal_brightness_enable_animation,
                    R.drawable.ic_signal_brightness_enable);
    private final AnimationIcon mDisable =
            new AnimationIcon(R.drawable.ic_signal_brightness_disable_animation,
                    R.drawable.ic_signal_brightness_disable); 
    ...
    protected void handleClick() {
        ...
        final boolean wasEnabled = brightnessMode != SCREEN_BRIGHTNESS_MODE_MANUAL;
