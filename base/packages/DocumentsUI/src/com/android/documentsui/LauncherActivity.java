...
public class LauncherActivity extends Activity {
    ...
    private void startTask() {
        ...
        startActivity(buildBrowseIntent());
    }
	...
	public Intent buildBrowseIntent() {
		String DOCUMENT_AUTHORITY = "com.android.externalstorage.documents";
		String DOCUMENT_ROOT_PRIMARY_EMULATED = "primary";
    ...
    private static Uri buildLaunchUri() {
		return Uri.parse("content://com.android.externalstorage.documents/root/primary");
