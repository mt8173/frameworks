...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.Global.SHOW_PERCENTAGE,
                    R.integer.show_precentage);
					
			loadSetting(stmt, Settings.Global.SHOW_NETSPEED,
                    SystemProperties.getInt("ro.wisky.show_netspeed",0));
            ...
            loadSetting(stmt, Settings.Global.CAPTIVE_PORTAL_DETECTION_ENABLED,0);
